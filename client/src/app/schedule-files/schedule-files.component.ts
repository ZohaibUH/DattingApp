...
@Component({
  selector: 'app-schedule-files',
  templateUrl: './schedule-files.component.html',
  styleUrls: ['./schedule-files.component.css']
})
export class ScheduleFilesComponent implements OnInit {
  ...
  constructor(private scheduleservice: ScheduleFilesService,private toastr:ToastrService, 
  ...
  //}); 
 */ 
  this.Gettingfiles=this.activateRoute.snapshot.data['scheduleFiles'] ; 
 ...
 // console.log( this.tableRows );
  ...
  {  
   ...
   this.scheduleservice.closeFile(path); 
  }  
  reload() 
  { 
